...
public class Country implements Comparable<Country> {
	...
	private String confederation; // confederation of the team
	private int power; // the power of the country
	
	private int group; // group letter (1-8) the country is in
	...
	// Country constructor
	public Country(String name, int potNumber, String confederation, int power) {
		this.name = name;
